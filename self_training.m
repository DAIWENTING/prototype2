function [ selected_sample ] = self_training( lab_idx,unlab_idx,selected_cluster, cluster_list,dec_values,D, r,flag)
...
for i = 1:num_c
    ...
    %d = 0;
    d = D(a, selected_cluster(i))*1;
    
    if(flag == 1)%representive
        ref{i,1} = d;   
    else %certainty
        ref{i,1} = -abs(dec_values(a,1));
    end
